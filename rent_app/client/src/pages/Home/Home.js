            ...
            <Container className="intro">
              <Row>
                ...
                <Col size="md-6">
                  ...
                  <h4>Your property management solution</h4>
                  <hr />
              ...
              <Container className="noBackground">
                ...
                <Row>
                  ...
                  <Col size="md-4">
                    <Container>
                      <div className="lowerCase">
                        <p>Access detailed and clear reporting which allows you as a landlord to always have accurate and up to date information about the state of affairs at each of your properties. Thus assisting with making informed, timely and effective management decisions.</p>
                      </div>
                    </Container>
                  </Col>
                </Row>
              ...
              <Row>
                <Container>
                  <div className="align-center">
                    ...
                    <ul className="align-left lowerCase">
                    <li>Using Rent Keeper for property management your accounting and efficiency will significantly improve. Save time, money and energy which can be used to solve additional problems while at the same time improving the speed and quality of communications with your tenants.</li>
                    <li>Access detailed reports for managers will provide up-to-date and reliable information about the state of affairs at each property, which will allow making timely and correct management decisions.</li>
